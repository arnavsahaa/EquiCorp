...
export function Hero() {
  return (
    <section className="py-20 md:py-28 bg-gradient-to-br from-nature-green/10 to-nature-leaf/20 dark:from-nature-forest/40 dark:to-nature-moss/30">
        ...
        <div className="text-center mx-auto max-w-3xl">
          <div className="inline-flex items-center gap-2 bg-nature-green/20 px-3 py-1 rounded-full text-nature-forest dark:text-nature-leaf font-medium text-sm mb-4">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-nature-green dark:bg-nature-leaf opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-nature-green dark:bg-nature-leaf"></span>
            </span>
            GNEC Hackathon Project
          </div>
        
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 animate-fade-in">
            Ending Workplace <span className="bg-gradient-to-r from-nature-green to-nature-leaf bg-clip-text text-transparent">Discrimination</span> Together
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center animate-fade-in" style={{animationDelay: "400ms"}}>
            <Button size="lg" className="bg-nature-green hover:bg-nature-forest text-white hover-lift">
              Report an Issue <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
            <Button size="lg" variant="outline" className="border-nature-green hover:bg-nature-green/10 dark:hover:bg-nature-green/20 hover-lift">
              Explore Resources
            </Button>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4 pt-10 animate-fade-in" style={{animationDelay: "600ms"}}>
            <div className="flex items-center gap-2">
              <Shield className="h-5 w-5 text-nature-green" />
              <span className="text-sm">100% Confidential</span>
            </div>
            <div className="flex items-center gap-2">
              <Users className="h-5 w-5 text-nature-green" />
