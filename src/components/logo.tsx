...
export function Logo() {
  return (
    <div className="flex items-center gap-2 group">
      ...
      <span className="text-xl font-bold tracking-tight bg-gradient-to-br from-nature-forest via-nature-green to-nature-sage bg-clip-text text-transparent group-hover:opacity-80 transition-opacity">EquiCorp</span>
    </div>
  );
}
